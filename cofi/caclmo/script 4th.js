...
function calcu() {
  ...
  if (s > 0) {
    ...
    scoff =
      ca + cfr + cang + cmath + cph + cinf + csvt + csp + cmada + cis + cthc;
    //*__________somme de note de mat_________
    not =
      nar + nfr + nang + nmath + nph + ninf + nsp + nmad + nis + ntech + nsvt;
