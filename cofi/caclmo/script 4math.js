...
function calcu() {
  ...
  if (s > 0) {
    ...
    let nmath = ((vmath1 + vmath2 + vmath3 * 2) / 3) * cmath;
    ...
    scoff = ca + cfr + cang + cmath + cph + cinf + csvt + csp + cmada + cthc;
    //*__________somme de note de mat_________
    not = nar + nfr + nang + nmath + nph + ninf + nsp + nmad + ntech + nsvt;
    ...
    getdoi("res6").innerHTML = "votre moyenne svt: " + nsvt.toFixed(2);
    getdoi("res9").innerHTML = "votre moyenne SPOR: " + nsp.toFixed(2);
    getdoi("res10").innerHTML = "votre moyenne OPTION: " + nmad.toFixed(2);
    getdoi("res12").innerHTML =
      "votre moyenne MATHÉMATIQUE : " + nmath.toFixed(2);
    getdoi("res13").innerHTML = "votre moyenne PHILO : " + ntech.toFixed(2);
