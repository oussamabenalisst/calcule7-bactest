...
function calcu() {
  ...
  vtech1 = parseFloat(getdoi("vtech1").value);
  vtech2 = parseFloat(getdoi("vtech2").value);
  ...
  if (s > 0) {
    ...
    let ntech = ((vtech1 + vtech2 + vtech3 * 2) / 4) * cthc;
    ...
    getdoi("res12").innerHTML =
      "votre moyenne TECHNOLOGIE : " + ntech.toFixed(2);
